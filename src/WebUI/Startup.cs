using chief_schedule.Application;
using chief_schedule.Application.Common.Interfaces;
using chief_schedule.Infrastructure;
using chief_schedule.Infrastructure.Persistence;
using chief_schedule.WebUI.Filters;
...
namespace chief_schedule.WebUI;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            configure.Title = "chief_schedule API";
