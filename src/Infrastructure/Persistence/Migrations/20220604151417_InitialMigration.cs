        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetNumberOfHours = table.Column<int>(type: "int", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProject", x => new { x.ProjectsId, x.WorkersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegisteredJobs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegisteredJobs_ProjectTasks_ProjectTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegisteredJobs_ProjectTaskId",
                table: "RegisteredJobs",
                column: "ProjectTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_RegisteredJobs_UserId",
                table: "RegisteredJobs",
                column: "UserId");
